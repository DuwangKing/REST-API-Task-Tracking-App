...
Учебный проект REST API для управления задачами (Todo-приложение). Проект демонстрирует навыки бэкенд-разработки на .NET, включая работу с реляционными базами данных, валидацию входных данных и покрытие кода модульными тестами.
